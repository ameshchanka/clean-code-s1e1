...
var completedTasksHolder=document.getElementById("tasks-done__list");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    editButton.className="button__task button_edit";

    deleteButton.className="button__task button_delete";
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("li_edit");
    ...
    listItem.classList.toggle("li_edit");
};
